...
[![Huggingface](https://img.shields.io/badge/Hugging_face-HPSv2-yellow)](https://hf-mirror.com/spaces/xswu/HPSv2)
...
*  [08/02/2023] Updated [test.json](https://hf-mirror.com/datasets/zhwang/HPDv2/blob/main/test.json) to include raw annotation by each annotator.
*  [07/29/2023] We included `SDXL Refiner 0.9` model in the benchmark.
*  [07/29/2023] We released [the benchmark and HPD v2 test data](https://hf-mirror.com/datasets/zhwang/HPDv2). HPD v2 train data will be released soon.
*  [07/27/2023] We included `SDXL Base 0.9` model in the benchmark.
*  [07/26/2023] We updated our [compressed checkpoint](https://hf-mirror.com/spaces/xswu/HPSv2/resolve/main/HPS_v2_compressed.pt).
*  [07/19/2023] Live demo is available at 🤗[Hugging Face](https://hf-mirror.com/spaces/xswu/HPSv2).
...
We also provide [images](https://hf-mirror.com/datasets/zhwang/HPDv2/tree/main/benchmark/benchmark_imgs) generated by models in our [benchmark](#the-hps-v2-benchmark) used for evaluation. You can easily download the data and evaluate the models by running the following code.
...
To evaluate your own text-to-image generative model, you can prepare the images for evaluation base on the [benchmark prompts](https://hf-mirror.com/datasets/zhwang/HPDv2/tree/main/benchmark) we provide by running the following code:
...
HPS v2 checkpoint can be downloaded from [here](https://hf-mirror.com/spaces/xswu/HPSv2/resolve/main/HPS_v2_compressed.pt). The model and live demo is also hosted on 🤗 Hugging Face at [here](https://hf-mirror.com/spaces/xswu/HPSv2).
...
Currently, the test data can be downloaded from [here](https://hf-mirror.com/datasets/zhwang/HPDv2). You can inspect the test data at [https://tgxs002.github.io/hpd_test_vis/](https://tgxs002.github.io/hpd_test_vis/). Here is a screenshot:
